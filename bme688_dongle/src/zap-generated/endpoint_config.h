    ...
    {ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY),                      \
     ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE)}, /* DeviceTypeList */               \
        ...
        {ZAP_SIMPLE_DEFAULT(1), 0x0000FFFD, 2, ZAP_TYPE(INT16U),               \
         0}, /* ClusterRevision */                                             \
                                                                               \
        /* Endpoint: 4, Cluster: Illuminance Measurement (server) */           \
...
#define GENERATED_ENDPOINT_TYPES                                               \
  {                                                                            \
    {ZAP_CLUSTER_INDEX(0), 11, 98}, {ZAP_CLUSTER_INDEX(11), 5, 47},            \
        {ZAP_CLUSTER_INDEX(16), 3, 27}, {ZAP_CLUSTER_INDEX(19), 3, 27},        \
        {ZAP_CLUSTER_INDEX(22), 3, 27},                                        \
  }
...
#define FIXED_DEVICE_TYPES                                                     \
  {                                                                            \
    {0x0016, 1}, {0x0100, 1}, {0x0302, 1}, {0x0307, 1}, { 0x0106, 1 }          \
  }
