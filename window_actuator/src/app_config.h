...
#define RELAY_NODE_1 DT_ALIAS(relay1)
#define RELAY_NODE_2 DT_ALIAS(relay2)

static constexpr struct gpio_dt_spec relay = GPIO_DT_SPEC_GET(RELAY_NODE_1, gpios);
static constexpr struct gpio_dt_spec relay_second = GPIO_DT_SPEC_GET(RELAY_NODE_2, gpios);